...
!103 = metadata !{i32 786478, i32 0, metadata !104, metadata !"queue_multiplexer", metadata !"queue_multiplexer", metadata !"_Z17queue_multiplexerPVbPViS0_S0_S0_S2_S0_S0_S0_S2_S0_S0_S0_S2_S0_S0_S0_S2_S0_S0_S0_S2_S0_S0_S0_", metadata !104, i32 3, metadata !105, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i1*, i32*, i1*, i1*, i1*, i32*, i1*, i1*, i1*, i32*, i1*, i1*, i1*, i32*, i1*, i1*, i1*, i32*, i1*, i1*, i1*, i32*, i1*, i1*, i1*)* @queue_multiplexer, null, null, metadata !113, i32 29} ; [ DW_TAG_subprogram ]
!104 = metadata !{i32 786473, metadata !"queue_multiplexer/.apc/queue_multiplexer.cpp", metadata !"/home/teja/Documents/TAIGA/HLS", null} ; [ DW_TAG_file_type ]
