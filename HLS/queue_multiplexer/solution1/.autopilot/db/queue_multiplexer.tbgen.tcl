...
set portList { 
	...
	{ rx_data_b sc_in sc_lv 32 signal 4 } 
	{ rx_ready_b sc_out sc_logic 1 signal 5 } 
	{ rx_valid_b sc_in sc_logic 1 signal 6 } 
	{ rx_data sc_out sc_lv 32 signal 7 } 
	{ rx_ready sc_in sc_logic 1 signal 8 } 
	{ rx_valid sc_out sc_logic 1 signal 9 } 
	{ tx_data_a sc_out sc_lv 32 signal 10 } 
	{ tx_ready_a sc_in sc_logic 1 signal 11 } 
	{ tx_valid_a sc_out sc_logic 1 signal 12 } 
	{ tx_data_b sc_out sc_lv 32 signal 13 } 
	{ tx_ready_b sc_in sc_logic 1 signal 14 } 
	{ tx_valid_b sc_out sc_logic 1 signal 15 } 
	{ tx_data sc_in sc_lv 32 signal 16 } 
	{ tx_ready sc_out sc_logic 1 signal 17 } 
	{ tx_valid sc_in sc_logic 1 signal 18 } 
}
set NewPortList {[ 
