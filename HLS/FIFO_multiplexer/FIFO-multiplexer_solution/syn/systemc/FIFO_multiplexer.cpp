...
const bool FIFO_multiplexer::ap_true = true;
const sc_lv<1> FIFO_multiplexer::ap_const_lv1_0 = "0";
const sc_lv<32> FIFO_multiplexer::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_logic FIFO_multiplexer::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic FIFO_multiplexer::ap_const_logic_0 = sc_dt::Log_0;

FIFO_multiplexer::FIFO_multiplexer(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "FIFO_multiplexer_sc_trace_" << apTFileNum ++;
    ...
    mHdltvinHandle.open("FIFO_multiplexer.hdltvin.dat");
    mHdltvoutHandle.open("FIFO_multiplexer.hdltvout.dat");
}

FIFO_multiplexer::~FIFO_multiplexer() {
    if (mVcdFile) 
...
void FIFO_multiplexer::thread_rx_data() {
...
void FIFO_multiplexer::thread_rx_ready_a() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_rx_ready_b() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_rx_tlast() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_rx_valid() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_switch_select_read_read_fu_76_p2() {
    switch_select_read_read_fu_76_p2 =  (sc_lv<1>) (switch_select.read());
}

void FIFO_multiplexer::thread_tx_data_a() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_tx_data_b() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_tx_ready() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_tx_tlast_a() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_tx_tlast_b() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_tx_valid_a() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_tx_valid_b() {
    if (!esl_seteq<1,1,1>(switch_select_read_read_fu_76_p2.read(), ap_const_lv1_0)) {
...
void FIFO_multiplexer::thread_hdltv_gen() {
