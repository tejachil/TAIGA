...
#ifndef _FIFO_multiplexer_HH_
#define _FIFO_multiplexer_HH_
...
struct FIFO_multiplexer : public sc_module {
    ...
    // Module declarations
    FIFO_multiplexer(sc_module_name name);
    SC_HAS_PROCESS(FIFO_multiplexer);
