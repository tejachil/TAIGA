...
set Library     "hls"
set IPName      "fifo_dequeue"
set Version     "1.0"
set DisplayName "Fifo_dequeue"
set Revision    "1503292046"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "fifo_dequeue_top"
...
set Interfaces {
    S_AXI_AXI_FIFO {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_axi_fifo"
        param_prefix "C_S_AXI_AXI_FIFO"
        addr_bits "5"
    }
    interrupt {
        type "interrupt"
