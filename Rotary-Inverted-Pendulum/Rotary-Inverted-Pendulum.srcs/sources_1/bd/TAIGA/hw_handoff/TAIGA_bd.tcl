...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_BRANCH_TARGET_CACHE_SIZE {0} CONFIG.C_CACHE_BYTE_SIZE {4096} CONFIG.C_DCACHE_BYTE_SIZE {4096} CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_D_AXI {1} CONFIG.C_D_LMB {1} CONFIG.C_FSL_LINKS {1} CONFIG.C_I_LMB {1} CONFIG.C_MMU_DTLB_SIZE {2} CONFIG.C_MMU_ITLB_SIZE {1} CONFIG.C_MMU_ZONES {2} CONFIG.C_USE_BARREL {1} CONFIG.C_USE_DIV {1} CONFIG.C_USE_FPU {2} CONFIG.C_USE_HW_MUL {1} CONFIG.C_USE_MSR_INSTR {1} CONFIG.C_USE_PCMP_INSTR {0} CONFIG.C_USE_REORDER_INSTR {0} CONFIG.G_TEMPLATE_LIST {3}  ] $IO_intermediary
  ...
  set_property -dict [ list CONFIG.C_BRANCH_TARGET_CACHE_SIZE {0} \
