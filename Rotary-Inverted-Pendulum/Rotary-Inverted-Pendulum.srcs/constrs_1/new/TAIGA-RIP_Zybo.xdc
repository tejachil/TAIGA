...
##IO_L24N_T3_34
set_property PACKAGE_PIN P16 [get_ports {gpio_btn_tri_i[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_btn_tri_i[1]}]

##IO_L18P_T2_34
set_property PACKAGE_PIN V16 [get_ports {gpio_btn_tri_i[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_btn_tri_i[2]}]

##IO_L7P_T1_34
set_property PACKAGE_PIN Y16 [get_ports {gpio_btn_tri_i[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_btn_tri_i[3]}]

#LEDs
#IO_L23P_T3_35
set_property PACKAGE_PIN M14 [get_ports {gpio_trigger[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_trigger[0]}]

##IO_L23N_T3_35
set_property PACKAGE_PIN M15 [get_ports {gpio_led_ioi_tri_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led_ioi_tri_o[0]}]

##IO_0_35
set_property PACKAGE_PIN G14 [get_ports {gpio_led_backup_tri_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led_backup_tri_o[0]}]

##IO_L3N_T0_DQS_AD1N_35
set_property PACKAGE_PIN D18 [get_ports {gpio_led_production_tri_o[0]}]
...
#set_property PACKAGE_PIN Y14 [get_ports {reconfiguration_uart_txd}]
#set_property IOSTANDARD LVCMOS33 [get_ports {reconfiguration_uart_txd}]
...
#set_property PACKAGE_PIN T12 [get_ports {reconfiguration_uart_rxd}]
#set_property IOSTANDARD LVCMOS33 [get_ports {reconfiguration_uart_rxd}]
...
set_property PACKAGE_PIN U15 [get_ports {ioi_uart_txd}]
...
set_property PACKAGE_PIN V17 [get_ports {ioi_uart_rxd}]
...
set_property PACKAGE_PIN V12 [get_ports {spi_plant_ss_o[2]}]
...
set_property PACKAGE_PIN V13 [get_ports {spi_plant_ss_o[0]}]
...
set_property PACKAGE_PIN U17 [get_ports {spi_plant_ss_o[1]}]
...
set_property PACKAGE_PIN T17 [get_ports {spi_plant_ss_o[3]}]
